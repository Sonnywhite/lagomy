...
public final class ProductData {
  ...
  @JsonCreator
  public ProductData(String message, String phrase) {
  ...
  public boolean equals(@Nullable Object another) {
    if (this == another)
      return true;
    return another instanceof ProductData && equalTo((ProductData) another);
  }

  private boolean equalTo(ProductData another) {
