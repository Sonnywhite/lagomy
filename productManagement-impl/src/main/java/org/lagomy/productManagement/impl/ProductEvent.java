...
//xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
 ...
 @Immutable
 @JsonDeserialize
 public final class PassPhraseChangedEvent implements ProductEvent {
   public final String message;
   public final String phrase;

   @JsonCreator
   public PassPhraseChangedEvent(String message, String phrase) {
     this.message = Preconditions.checkNotNull(message, "message");
   ...
   public boolean equals(@Nullable Object another) {
     if (this == another)
       return true;
     return another instanceof PassPhraseChangedEvent && equalTo((PassPhraseChangedEvent) another);
   }

   private boolean equalTo(PassPhraseChangedEvent another) {
